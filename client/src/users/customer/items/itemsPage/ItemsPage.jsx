...
export function ItemsPage(){
    ...
    const ItemsPageFilters=()=>{
        return(
            <>
                <div className="customer-itemsPage-filter-category">
                    <button onClick={openList}>
                        {selectedCategory}
                        <img src={open ? "/icons/up-dark.png" : "/icons/down-dark.png"} alt="img"/>
                    </button>
                    {open && (
                        <div className="customer-itemsPage-item-types">
    ...
    return(
        loading ? (
            ...
            <div className="customer-itemsPage">
                <div className="customer-itemsPage-all">
                    <div className="customer-itemsPage-options">
                        <div className="customer-itemsPage-search">
                            <img src="/icons/search.png" alt="img"/>
                            <input type="text" placeholder="Search" onChange={(e)=>setSearchItem(e.target.value)}/>
                        </div>
                        <div className="customer-itemsPage-expand">
                            <img src={openAll ? "/icons/up.png" : "/icons/down.png"} alt="" onClick={openFiltersDropdown}/>
                        </div>
                    </div>

                    <div className="customer-itemsPage-filter-dropdown">
                        {openAll ? (
                            <div className="customer-itemsPage-filter-and-sort-dropdown">
                                <ItemsPageSort/>
                                <ItemsPageFilters/>
                    ...
                    <div className="customer-itemsPage-filter-and-sort">
                        <div className="customer-itemsPage-filter-and-sort-only">
                            <ItemsPageSort/>
                            <ItemsPageFilters/>
                        </div>
                        <div className="customer-itemsPage-price-slider">
                ...
                <div className="customer-itemsPage-items">
